...
def cron_task_factory(
    *, task: Task, trigger: BaseTrigger, func: typing.Callable | None = None
) -> Task:
    """Create Task classes with a trigger."""
